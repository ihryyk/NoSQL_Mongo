...
public class MigrationService {
    ...
    public void migrate() throws SQLException {
        try (MongoClient mongoClient = MongoClients.create(MONGODB_URL);
            ...
            migrateUsersAndTickets(connection, mongoDatabase);
        }
    }

    private void migrateUsersAndTickets(Connection connection, MongoDatabase mongoDatabase) throws SQLException {
        ...
        try (PreparedStatement psUsers = connection.prepareStatement(SELECT_USERS);
            ...
            while (rsUsers.next()) {
                Document user = new Document()
                        ...
                        .append("money", rsUsers.getBigDecimal("money"));
